...
from flask_restful_api.models import TagModel
from flask_restful_api.models import ItemModel
...
class Tag(Resource):
    ...
    parser.add_argument(
        ...
        type=int,
        required=True,
        help="To create of add a tag to an item, please provide the item_id"
    )
